...
import { getModelUID } from 'src/global/utils'
import { IOrganizationDocument, IOrganizationModel } from './types/Organization.types'

const OrganizationSchema: Schema = new Schema<IOrganizationDocument, IOrganizationModel>(
  {
    ...BaseModelSchema.obj,
    uid: {
      type: String,
